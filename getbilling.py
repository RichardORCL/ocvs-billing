...
application_version = "13.05.2026"
...
for region in selected_regions:
    ...
    for c in compartments:
        line = f"Scanning {region}: compartments for unused billing terms (billing donors): {c.fullpath}"
        # Erase the line completely before printing new output
        sys.stdout.write('\r' + ' ' * (len(line) + 10) + '\r')  # Clear previous content
        print(line, end="\r")
        try:
